...
class insert2{
    void insertData() throws ClassNotFoundException, SQLException {
            ...
            String sql2 = "SELECT department.deptname FROM department";
            PreparedStatement ps1 = con.prepareStatement(sql2);
            ResultSet rs1 = ps1.executeQuery();
            while (rs1.next()){
                String deptName1 = rs1.getString(1);
                if (deptName1.equals(deptName1)){
                    String sql3 = "SELECT deptID FROM department WHERE deptname=?";
